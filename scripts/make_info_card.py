...
# ===========================================================================
HOST = "j0hn-char"   # shown as  j0hn-char@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack Developer"),
    ("kv", "Edu", "CS Student @ University of Macedonia"),
    ("kv", "Also", "IEEE UoM Student Branch Chair"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, JavaScript, TypeScript, C, Python"),
    ("kv", "Frontend", "React, Vite, Tailwind CSS"),
    ("kv", "Backend", "Spring Boot, FastAPI, MySQL, MongoDB"),
    ("kv", "Tools", "Docker, Git, Maven"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AiMD -- AI medical assistant, RAG + Claude, Netcompany Hackathon 2026"),
    ("bul", "Wallie -- AI budget planner, multi-currency support"),
    ("bul", "UniBank -- Spring Boot/JWT banking system w/ React frontend"),
]
