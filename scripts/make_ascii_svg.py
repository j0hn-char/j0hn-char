...
CONTRAST = 1.05
BRIGHTNESS = 1.0
GAMMA = 0.75          # <1 brightens mids -> face lands in sparser chars
SHARPEN = False
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">j0hn-char@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'j0hn-char@github:~$ whoami <tspan fill="{INK}">Ioannis Charalampidis</tspan></text>')
